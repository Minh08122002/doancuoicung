...
<body>
<div>
    <span ><img style="width: 220px;height: 80px;padding-top: 30px;padding-left:10%" src="/images/hoatdong/hoatdong.png"></span>
    <span style="font-size:25px;font-weight:bold">HOẠT ĐỘNG</span>
...
<table class="table1"  style="margin-top: 30px;margin-right:10%;border: 2px solid;border-radius:30px">
            <tr>
                <td class="td1" style="text-align: center;font-weight:bold;color:white;background-color: #FF3333;border:2px;padding:1em;border-radius:30px 30px 0px 0px">HOẠT ĐỘNG</td>
            </tr>
            <tr>
    ...
    <table class="table2"  style="margin-top: 30px;margin-right:10%;border: 2px solid;border-radius:30px">
            <tr>
                <td class="td2" style="text-align: center;font-weight:bold;color:white;background-color: #00CC00;border:2px;padding:1em;border-radius:30px 30px 0px 0px">THÔNG BÁO</td>
            </tr>
            <tr>
        ...
        <table class="table2"  style="margin-top: 30px;margin-right:10%;border: 2px solid;border-radius:30px">
            <tr>
                <td class="td2" style="text-align: center;font-weight:bold;color:white;background-color: #FF0099;border:2px;padding:1em;border-radius:30px 30px 0px 0px">THỰC ĐƠN BỮA ĂN</td>
            </tr>
            <tr>
                <td class="td2" style="border-top:solid">tb1</td>
            </tr>
