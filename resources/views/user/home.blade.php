...
<html lang="en">
    ...
    <body>
        ...
        <div class="display-container" style="margin-top:10px;margin-left:2.5%;margin-right:2.5%;"> 
            <img class="mySlides3" src="/image/bannerhome/banner1.png"> 
            <img class="mySlides3" src="/image/bannerhome/banner2.png"> 
            <img class="mySlides3" src="/image/bannerhome/banner3.png"> 
